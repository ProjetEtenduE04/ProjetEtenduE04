...
{
    public partial class MergeFixINIT : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "7cc96785-8933-4eac-8d7f-a289b28df223", 0, "b3ea3d53-05f1-443a-9978-38833d553aa5", "ApplicationUser", "bit@gmail.com", true, false, null, "BIT@GMAIL.COM", "BIT@GMAIL.COM", null, null, false, "1031dfcf-273a-484e-b601-d652ecfc7aa3", false, "bit@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "test@clinique2000.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 22, 22, 12, 25, 94, DateTimeKind.Local).AddTicks(2605), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "CliniqueA", "(438) 333-5555", 30 });

            migrationBuilder.InsertData(
                table: "Cliniques",
                columns: new[] { "CliniqueID", "AdresseID", "Courriel", "CreateurID", "DateCreation", "DateModification", "EstActive", "HeureFermeture", "HeureOuverture", "NomClinique", "NumTelephone", "TempsMoyenConsultation" },
                values: new object[] { 2, 2, "Test2@test.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 22, 22, 12, 25, 94, DateTimeKind.Local).AddTicks(2652), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "CliniqueB", "(438) 333-7777", 30 });
