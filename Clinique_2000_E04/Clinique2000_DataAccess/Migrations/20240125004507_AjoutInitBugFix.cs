<<<<<<<< HEAD:Clinique_2000_E04/Clinique2000_DataAccess/Migrations/20240126043749_fix.cs
﻿using System;
...
namespace Clinique2000_DataAccess.Migrations
{
    public partial class AjoutInitBugFix : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7cc96785-8933-4eac-8d7f-a289b28df223", 0, "27054127-d3cd-40d6-b901-d995dc516240", "ApplicationUser", "patient1@example.com", true, false, null, "PATIENT1@EXAMPLE.COM", "PATIENT1@EXAMPLE.COM", null, null, false, "233b74e4-0e66-4e1f-879b-6ceac07264f0", false, "patient1@example.com" },
                    { "e2b8f367-6c94-4a3e-b5a6-45dabec4d2e2", 0, "6e5fbee9-5c65-4379-9c7b-0428b35b3fea", "ApplicationUser", "patient2@example.com", true, false, null, "PATIENT2@EXAMPLE.COM", "PATIENT2@EXAMPLE.COM", null, null, false, "d56a09a3-9128-4a10-b19f-04f9477b7a95", false, "patient2@example.com" },
                    { "f3c9e478-8d81-4aaf-aa77-56e1d3f5f3f3", 0, "dc0c85c5-2776-42d8-8506-92b8c812d5a7", "ApplicationUser", "patient3@example.com", true, false, null, "PATIENT3@EXAMPLE.COM", "PATIENT3@EXAMPLE.COM", null, null, false, "d2956fb2-383c-4730-b1a3-0facbf99513c", false, "patient3@example.com" },
                    { "g4d0a589-2b02-4d36-9a85-39c028a4g4g4", 0, "0b2f275e-2154-47dd-acef-c8ee4bbdbb61", "ApplicationUser", "patient4@example.com", true, false, null, "PATIENT4@EXAMPLE.COM", "PATIENT4@EXAMPLE.COM", null, null, false, "1bad6ad0-ae0c-47fd-9dc8-a8519420ef33", false, "patient4@example.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "test@clinique2000.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(237), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "CliniqueA", "(438) 333-5555", 30 },
                    { 2, 2, "Test2@test.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(282), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "CliniqueB", "(438) 333-7777", 30 },
                    { 3, 3, "contact@clinique3.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(294), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "Clinique3", "(100) 100-1030", 30 },
                    { 4, 4, "contact@clinique4.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(303), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "Clinique4", "(100) 100-1040", 30 },
                    { 5, 5, "contact@clinique5.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(311), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "Clinique5", "(100) 100-1050", 30 },
                    { 6, 6, "contact@clinique6.com", "7cc96785-8933-4eac-8d7f-a289b28df223", new DateTime(2024, 1, 24, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(320), null, true, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "Clinique6", "(100) 100-1060", 30 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, new DateTime(2024, 1, 25, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(337), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 2, 3, new DateTime(2024, 1, 26, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(349), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 3, 3, new DateTime(2024, 1, 27, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(357), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 4, 3, new DateTime(2024, 1, 28, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(365), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 5, 3, new DateTime(2024, 1, 29, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(407), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 2 },
                    { 6, 3, new DateTime(2024, 1, 30, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(416), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 3 },
                    { 7, 4, new DateTime(2024, 1, 25, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(425), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 8, 4, new DateTime(2024, 1, 26, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(432), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 9, 4, new DateTime(2024, 1, 27, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(440), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 10, 4, new DateTime(2024, 1, 28, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(449), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 11, 4, new DateTime(2024, 1, 29, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(456), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 2 },
                    { 12, 4, new DateTime(2024, 1, 30, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(464), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 3 },
                    { 13, 5, new DateTime(2024, 1, 25, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(471), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 14, 5, new DateTime(2024, 1, 26, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(478), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 15, 5, new DateTime(2024, 1, 27, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(486), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 16, 5, new DateTime(2024, 1, 28, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(494), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 17, 5, new DateTime(2024, 1, 29, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(502), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 2 },
                    { 18, 5, new DateTime(2024, 1, 30, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(511), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 3 },
                    { 19, 6, new DateTime(2024, 1, 25, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(519), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 20, 6, new DateTime(2024, 1, 26, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(526), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 21, 6, new DateTime(2024, 1, 27, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(534), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 2 },
                    { 22, 6, new DateTime(2024, 1, 28, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(541), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), true, 3 },
                    { 23, 6, new DateTime(2024, 1, 29, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(549), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 2 },
                    { 24, 6, new DateTime(2024, 1, 30, 19, 45, 7, 486, DateTimeKind.Local).AddTicks(557), 30, new TimeSpan(0, 17, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), false, 3 }
                });
...
>>>>>>>> origin/FCT_BUGFIX_Sprint2_Design:Clinique_2000_E04/Clinique2000_DataAccess/Migrations/20240125004507_AjoutInitBugFix.cs
